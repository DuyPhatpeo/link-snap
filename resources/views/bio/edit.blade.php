...
<div class="bg-[#F8F9FB] min-h-screen pb-16">
    ...
    <div class="bg-white/80 backdrop-blur-md border-b border-slate-200/80 sticky top-0 z-30 transition-all">
        <div class="max-w-7xl mx-auto px-3 sm:px-6 h-16 md:h-18 flex items-center justify-between gap-3">
            ...
            <div class="hidden md:flex items-center bg-slate-100/80 p-1 rounded-xl border border-slate-200/60 shrink-0">
                <button onclick="Editor.setTab('links')" id="tab-btn-links" class="tab-btn active px-4 py-1.5 rounded-lg text-[11px] font-black font-outfit uppercase tracking-wider transition-all">Liên kết</button>
                <button onclick="Editor.setTab('appearance')" id="tab-btn-appearance" class="tab-btn px-4 py-1.5 rounded-lg text-[11px] font-black font-outfit uppercase tracking-wider transition-all text-slate-400 hover:text-slate-600">Giao diện</button>
                <button onclick="Editor.setTab('settings')" id="tab-btn-settings" class="tab-btn px-4 py-1.5 rounded-lg text-[11px] font-black font-outfit uppercase tracking-wider transition-all text-slate-400 hover:text-slate-600">Cài đặt</button>
            </div>

            <div class="flex items-center gap-2 shrink-0">
                <a href="{{ route('bio.show', $bioPage->slug) }}" target="_blank" class="flex items-center gap-1.5 text-indigo-600 hover:text-indigo-700 font-black font-outfit text-[11px] uppercase tracking-wider px-3.5 py-1.5 hover:bg-indigo-50 rounded-xl transition-all border border-indigo-100">
