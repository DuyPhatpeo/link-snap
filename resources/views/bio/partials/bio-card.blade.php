...
<div class="glass-card rounded-2xl p-4 sm:p-5 border border-slate-200/80 hover:border-indigo-300 hover:shadow-lg transition-all duration-300 group relative cursor-pointer flex flex-col justify-between">
    ...
    <div>
        ...
        <div class="flex items-center gap-3.5 mb-4">
            <div class="w-10 h-10 rounded-xl bg-indigo-600 p-[1.5px] shadow-sm shrink-0">
    ...
    <div class="relative z-10 flex items-center justify-between pt-3 border-t border-slate-100">
        ...
        <div class="flex gap-1.5">
            <a href="{{ route('bio.show', $page->slug) }}" target="_blank" class="relative z-20 p-2 bg-slate-50 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-all" title="Xem trang">
            ...
            <button onclick="event.stopPropagation(); BioManager.deletePage('{{ $page->slug }}')" class="relative z-20 p-2 bg-slate-50 text-slate-400 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-all" title="Xóa trang">
