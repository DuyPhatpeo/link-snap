...
<div id="tab-preview" class="tab-content hidden md:hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
    <div class="glass-card rounded-3xl p-5 shadow-sm border border-slate-200/80">
        <div class="mb-4 flex items-center justify-between">
            <h2 class="text-base font-black font-outfit text-slate-800 tracking-tight">Xem trước di động</h2>
            <button onclick="Editor.refreshPreview()" class="p-2 bg-slate-100 hover:bg-slate-200 text-slate-500 rounded-xl transition-all" title="Làm mới">
