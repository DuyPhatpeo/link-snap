...
<div id="tab-settings" class="tab-content hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
    <section class="glass-card rounded-2xl p-6 sm:p-8 border border-slate-200/80 shadow-sm">
        ...
        <div class="space-y-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 sm:p-5 bg-slate-50 rounded-xl border border-slate-200/80">
                <div class="space-y-1">
                ...
                <button onclick="Editor.copyBioLink(this)" 
                    ...
                    class="bg-white hover:bg-slate-100 text-slate-800 font-bold px-4 py-2 rounded-lg border border-slate-200 text-xs transition-all shadow-sm active:scale-95 whitespace-nowrap">
                    Sao chép link
                </button>
            </div>

            <div class="p-5 border-2 border-dashed border-rose-200 rounded-xl bg-rose-50/20">
                ...
                <button onclick="Editor.deleteBio()" class="bg-rose-500 hover:bg-rose-600 text-white font-bold font-outfit px-5 py-2.5 rounded-lg transition-all active:scale-95 text-xs uppercase tracking-wider shadow-sm shadow-rose-500/20">
                    Xóa Bio Page này
                </button>
            </div>
        </div>
