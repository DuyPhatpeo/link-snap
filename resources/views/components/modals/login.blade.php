        ...
        <form onsubmit="Auth.handleLogin(event)" class="space-y-4">
            ...
            <div>
                ...
                <input type="email" name="email" required placeholder="name@example.com"
                    class="w-full bg-slate-50/80 border border-slate-200 rounded-xl py-2.5 px-3.5 outline-none focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-50 transition-all text-xs font-semibold text-slate-800">
            </div>
            ...
            <div class="relative">
                ...
                <div class="relative">
                    <input type="password" id="loginPwd" name="password" required placeholder="••••••••"
                        class="w-full bg-slate-50/80 border border-slate-200 rounded-xl py-2.5 pl-3.5 pr-12 outline-none focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-50 transition-all text-xs font-semibold text-slate-800">
