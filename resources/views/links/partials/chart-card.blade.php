...
<div class="glass-card rounded-2xl p-5 sm:p-6 border border-slate-200/80 shadow-sm animate-in fade-in duration-500 delay-400">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center gap-2 bg-indigo-50/80 px-3 py-1.5 rounded-full border border-indigo-100/80">
            <span class="w-1.5 h-1.5 bg-indigo-600 rounded-full shadow-[0_0_8px_rgba(79,70,229,0.5)] animate-pulse"></span>
